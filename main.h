...
/* Functions that prints out numbers */
...
int print_hexa_upper(va_list types, char buffer[],
	int flags, int wwidth, int precision, int size);
...
/* Function used to output a string in rot 13 */
...
int write_num(int ind, char bff[], int flags, int width, int precision,
	int length, char padd, char more);
int write_pointer(char buffer[], int ind, int length,
	int width, int flags, char padd, char more, int padd_start);
